...
sealed interface CourseCreatingState {
    ...
    data class Content(val background: String, val lessons: PersistentList<Lesson>) :
        CourseCreatingState
...
//    }
    data class Lesson(val x: Float, val y: Float, val image: String, val name: String, val id: Long)
}